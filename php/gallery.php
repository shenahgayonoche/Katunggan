...
<section class="hero gallery-hero">
  <div class="slides">
    <img src="../images/image1.webp" class="slide active" alt="Sunset over the cove">
    <img src="../images/image2.webp" class="slide" alt="Resort pathways">
  </div>
  ...
  <div class="container">
    ...
    <div class="gallery-grid">
      <article class="gallery-card wide tall">
        <img src="../images/image1.webp" alt="Resort pool at sunset" loading="lazy">
        <div class="gallery-caption">Sunset by the pool</div>
      </article>
      <article class="gallery-card">
        <img src="../images/image2.webp" alt="Garden walkway" loading="lazy">
        <div class="gallery-caption">Garden paths</div>
      </article>
      <article class="gallery-card">
        <img src="../images/image3.webp" alt="Resort room" loading="lazy">
        <div class="gallery-caption">Quaint rooms</div>
      </article>
      <article class="gallery-card tall">
        <img src="../images/image4.webp" alt="Mangrove view" loading="lazy">
        <div class="gallery-caption">Mangrove stillness</div>
      </article>
      <article class="gallery-card wide">
        <img src="../images/image5.webp" alt="Café table overlooking the water" loading="lazy">
